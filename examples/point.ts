...
/**
 * Namespace for shared Point functions.
 */
namespace Point {
    /**
...
class PointObject {
    ...
    subtract$(x: number, y: number) {
        return Point.subtract$(this, x, y);
    }
    ...
    equalsScalar(k: number) {
        return Point.equalsScalar(this, k);
    }
    ...
    epsilonEquals(other: Point, e: number) {
        return Point.epsilonEquals(this, other, e);
    }
    ...
    epsilonEqualsScalar(k: number, e: number) {
        return Point.epsilonEqualsScalar(this, k, e);
    }
    ...
    setMidpoint(p1: Point, p2: Point) {
        return Point.setMidpoint(this, p1, p2);
    }
    ...
    distance2(other?: Point) {
        return Point.distance2(this, other);
    }
}

export { PointObject as Point };
/**
